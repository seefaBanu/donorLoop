  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-row bg-gradient-to-r from-red-900 to-red-600 h-20 text-black py-4 px-8 shadow-md">
      ...
      {state.isAuthenticated ? (
       ...
       {sideMenuOpen && (
        <div className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 z-40" onClick={toggleSideMenu}>
          <div className="fixed top-0 right-0 bottom-0 w-64 bg-white shadow-lg z-50 " onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between  border-b-2">
              ...
              <IoMdClose className="flex text-2xl bg-gray-300 cursor-pointer justify-end " onClick={toggleSideMenu} />
              </div>
            </div>

            <div className="mb-4 ">
              <p className="text-base p-4 text-black cursor-pointer border-b-2 hover:bg-black hover:text-white transition duration-300" onClick={() => navigate("/camps")}>Camps</p>
              {group.includes("blood_bank") && (
                <p className="text-base p-4 text-black cursor-pointer border-b-2 hover:bg-black hover:text-white  transition duration-300" onClick={() => navigate("/find-blood")}>Find Blood</p>
              )}
              <p className="text-base p-4 text-black cursor-pointer border-b-2 hover:bg-black hover:text-white transition duration-300" onClick={() => navigate("/request")}>Requests</p>
            </div>
