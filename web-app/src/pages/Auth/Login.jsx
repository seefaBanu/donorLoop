    ...
    >
      <div className="rounded-3xl w-[50%] max-w-md p-4">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-m font-semi-bold mb-6">Register as</h1>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col items-center">
                <div className="flex border rounded-full p-5 border-b-gray-300">
                  <FaPeopleArrows className="w-10 h-10 text-gray-400 hover:text-red-700" />
                </div>
                <button
              ...
              <div className="flex flex-col items-center ">
                ...
                <button
                  className="flex my-2 text-black text-sm font-light hover:text-red-700 hover:scale-110 transition duration-300 hover:cursor-pointer"
                  onClick={() =>
                    (window.location.href =
                      "https://forms.gle/T2kLgu4jFodpQHXS7")
                  }
                >
                  Blood Bank
                </button>
          ...
          <p
            className="text-xs my-2 font-light hover:scale-110 transition duration-300 hover:cursor-pointer"
            onClick={() => navigate("/")}
          >
            Back to home
          </p>
